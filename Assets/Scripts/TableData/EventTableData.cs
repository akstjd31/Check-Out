...
public class EventTableData : TableBase
{
    ...
    public string conditionType1;       // 첫 번째 검사 조건
    public string conditionValue1;      // 첫 번째 조건의 비교 값
    public string conditionType2;       // 두 번째 검사 조건
    public string conditionValue2;      // 두 번째 조건의 비교 값
